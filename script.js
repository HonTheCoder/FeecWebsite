document.addEventListener('DOMContentLoaded', function () {
    ...
    if (mapElement) {
        // Initialize map
        // Coordinates: 14.284704696713888, 120.88904229511954
        const map = L.map('map').setView([14.284704696713888, 120.88904229511954], 18);
        ...
        const marker = L.marker([14.284704696713888, 120.88904229511954], { icon: glowingIcon }).addTo(map);

        // Add popup
        marker.bindPopup("<b>FACTOR-EMNAS ENTERPRISES CORP.</b><br>B 19 L 5 Beverly Homes Subd Bgy, Hugo Perez Rd,<br>Trece Martires City, 4109 Cavite, Philippines").openPopup();
    }
